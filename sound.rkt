...
(define sound-chopping (rs-read "Chopping.wav"))
;(rs-read path)
(define sound-gameover (rs-read "Game-over.wav"))
...
(define sound-menu (rs-read "menu.wav"))
(define sound-ingame (rs-read "ingame.wav"))
